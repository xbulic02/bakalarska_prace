...
ExternConverter::convertExternObject(ConversionContext* ctxt,
    ...
    if (emitExterns) {
        ...
        //pridano .toString(); bylo li volano pouze em->object->getName(), tak byla do JSONu zapisovana spatna hodnota
        etr->emplace("value", em->object->getName().toString());
...
ExternConverter::convertExternInstance(ConversionContext* ctxt,
    ...
    // implementace zapsani instance externu do JSONu    
    else {
