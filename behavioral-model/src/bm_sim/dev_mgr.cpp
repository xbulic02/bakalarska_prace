...
class FilesDevMgrImp : public DevMgrIface {
 ...
 private:
  ...
  //ziskani hodnoty inpktsnum
  unsigned int getInPktsNum(){
    return this->inPktsNum;
  }
  ...
  void start_() override {
    reader.start();
    //predani hodnoty z pcapfilereader
    DevMgrIface::setInPktsNum(reader.getInPktsNum());
  }
 ...
 private:
  ...
  //pocet vstupnich paketu
  unsigned int inPktsNum;
};
...
DevMgr::start() {
  assert(pimp);
  pimp->start();
  //* predani hodnoty z devmgriface do devmgr
  this->inPktsNum=pimp->getInPktsNum();
  //*******
}
...
//*** ziskani hodnoty inPktsNum
unsigned int DevMgrIface::getInPktsNum(){
  return this->inPktsNum;
}

//*** zapsani inPktsNum
void DevMgrIface::setInPktsNum(unsigned int inPktsNum){
  this->inPktsNum=inPktsNum;
}
