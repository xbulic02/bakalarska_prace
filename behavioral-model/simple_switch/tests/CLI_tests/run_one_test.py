...
def main():
    ...
    simple_switch_p = subprocess.Popen(
        ["/home/p4/skola/behavioral-model/targets/simple_switch/simple_switch", "-h"],
        stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
    simple_switch_p.wait()

    # start simple_switch
    simple_switch_p = subprocess.Popen(
        ["/home/p4/skola/behavioral-model/targets/simple_switch/simple_switch",
    ...
    cmd = ["/home/p4/skola/behavioral-model/tools/runtime_CLI.py",
    ...
    with open(command_path, "r") as f:
        ...
        sub_env["PYTHONPATH"] = pythonpath + \
                                "/home/p4/skola/behavioral-model/thrift_src/gen-py/"
